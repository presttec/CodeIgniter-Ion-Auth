...
| ------------------------------------ | ------------------------------------ |
| -[PrestTEC](http://presttec.com.br)| -[Config Options](#use_config)       |
| -[GitHub](https://github.com/PrestTEC)| **Class Functions**               |
| **Basic Info**                       | -   [login()](#login)                |
| -[License](#license)                 | -   [logout()](#logout)              |
| -[GitHub Repo](https://github.com/presttec/CodeIgniter-Ion-Auth) | -   [register()](#register) |
